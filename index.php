<?php 
	...
	$us = $_SESSION['egresado'];
	$sql = $datosEstudiante." WHERE tiposidentificaciones.num_doc = '$us'";
	$result = pg_query($sql);
...
<body  class="page page-id-2468 page-parent page-template-default readonstyle-button font-family-default font-size-is-default col12 menu-type-splitmenu">
	...
	<div class="cargando">
		<!--<img src="css/images/cargando.gif" alt="Cargando" />-->
		<p>Cargando...</p>
	</div>
...
<head>
	...
	<script type="text/javascript">
		...
		var cambiar = '<?php echo $_SESSION["cPass"] ?>'; // para mensaje de contraseña 
...
<body style="position:relative">
	...
	<div id="mensaje"></div>
	<nav>
		<label for="dPersonales">Datos Personales</label>
		<input type="radio" id="dPersonales" name="principal" value="" checked>
		<label for="eBasica">Educacion basica</label>
		<input type="radio" id="eBasica" name="principal" value="">
		<label for="eSuperior">Estudios superiores</label>
		<input type="radio" id="eSuperior" name="principal" value="">
		<label for="oEstudios">Otros Estudios</label>
		<input type="radio" id="oEstudios" name="principal" value="">
		<label for="iLaboral">Info. laboral</label>
		<input type="radio" id="iLaboral" name="principal" value="">
		<a href="pdf/usuario.pdf" name="principal" target="_blank">Ayuda</a>
		<a id="cPass">Contraseña</a>
		<a id="salir">Salir</a>
	</nav>
	<div id="idiomas">
		<ul id="checkIdiomas">
			<li>
				<input id="cbIngles" type="checkbox" value="37"/>
				<label for="cbIngles">Ingles</label>
			</li>
			<li>
				<input id="cbFrances" type="checkbox" value="42"/>
				<label for="cbFrances">Frances</label>
			</li>
			<li>
				<input id="cbItaliano" type="checkbox" value="47"/>
				<label for="cbItaliano">Italiano</label>
			</li>
			<li>
				<input id="cbPortugues" type="checkbox" value="52"/>
				<label for="cbPortugues">Portugues</label>
			</li>
			<li>
				<input id="cbMandarin" type="checkbox" value="57"/>
				<label for="cbMandarin">Mandarin</label>
			</li>
			<li>
				<input id="cbAleman" type="checkbox" value="62"/>
				<label for="cbAleman">Aleman</label>
			</li>
			<li>
				<input id="cbJapones" type="checkbox" value="67"/>
				<label for="cbJapones">Japones</label>
			</li>
			<li>
				<input id="cbArabe" type="checkbox" value="72"/>
				<label for="cbArabe">Arabe</label>
			</li>
		</ul>
	</div>
	<div id="_oEstudios" class="divWithTable">
		<div>
			<span class="titulos">Otros Estudios</span>
	...
	<div id="_dPersonales" class="divWithTable">
		<span class="titulos">Datos personales</span>
		<form action="">
			<div class="bloque">
				<label for="pApellido"  title="seleccione apellido">Primer Apellido</label>
				<input type="text" name="texto" id="pApellido" maxlength="30" required>
				<label for="sApellido">Segundo Apellido</label>
				<input type="text" name="texto" id="sApellido" maxlength="30">
				<label for="priNom">Primer Nombre</label>
				<input type="text" name="texto" id="priNom" maxlength="30" required>
				<label for="segNom">Segundo Nombre</label>
				<input type="text" name="texto" id="segNom" maxlength="30">
				...
				<label for="cedula" disabled>Nº de Cedula</label>
				<input type="text" id="cedula" name="number" required  readonly>
				<label for="fNacimiento">Fecha de nacimiento</label>
				<input type="text" id="fNacimiento"  class="fecha" required>
				<label for="genero">Genero</label>
				<select name="" id="sGenero">
					<option value="F">F</option>
					<option value="M">M</option>
				</select>
				<label for="sEstadoCivil">Estado civil</label>
				<select name="" id="sEstadoCivil">
					<option value="0">S.I</option>
					<option value="1">Soltero(a)</option>
					<option value="2">Casado(a)</option>
					<option value="3">Union Libre</option>
					<option value="4">Religioso(a)</option>
			...
			<div class="bloque">
				<label for="sPaisR">País de residencia</label>
				<select name="" id="sPaisR"></select>
				<label for="sDepR">Departamento de residencia</label>
				<select name="" id="sDepR"></select>
				<label for="sMunR">Municipio de residencia</label>
				<select name="" id="sMunR"></select>
				<label for="tDirR">Direccion de residencia</label>
				<input type="text" maxlength="60" id="tDirR">
				<label for="celular">Celular</label>
				<input type="text" id="celular" name="number">
				<label for="telefono">Telefono</label>
				<input type="text" id="telefono" maxlength="60" name="number">
				<label for="correo">Correo</label>
				<input type="email" id="correo" maxlength="60" required>
				<input type="button" id="btIdioma" name="principal" value="Idioma">
				
				<input type="submit" value="Guardar" name="principal">
			</div>
		</form>
	</div>
	<div id="_iLaboral" class="divWithTable">
		<div>
			<span class="titulos">Información laboral</span>
			<table id="tLaboral"></table>
	        <div id="pagerLaboral" ></div>
		</div>
	</div>
	<div id="_eBasica">
		<form id="">
			<label for="sPais">Pais</label>
			<select name="sPais" id="sPais"></select>
			<label for="sDep">Departamento</label>
			<select name="sDep" id="sDep"></select>
			<label for="sMun">Ciudad</label>
			<select name="sMun" id="sMun"></select>
			<label for="sBachillerato">Institución</label>
			<select name="sBachillerato" id="sBachillerato"></select>
			<label for="fEgreso">Fecha Egreso</label>
			<input type="text" id="fEgreso" name="fEgreso" class="fecha">
			<input type="button" id="btEB" value="Guardar">
		</form>
	</div>
	<div id="_eSuperior" >
		<form>
			<label for="stitulo">Titulo Otorgado</label>
			<select name="" id="sTitulo"></select>
			<label for="fEgresoES">Fecha Egreso</label>
			<input type="text" id="fEgresoES" name="datepicker" class="fecha">
			<input type="button" id="btES" value="Guardar">
		</form>
	</div>
	<div id="addOE">
		<form id="">
			<label for="sPais2">Pais</label>
			<select name="sPais" id="sPais2"></select>
			<label for="sDep2">Departamento</label>
			<select name="sDep" id="sDep2"></select>
			<label for="sMun2">Ciudad</label>
			<select name="sMun" id="sMun2"></select>
			<label for="sInstituto">Institución</label>
			<select name="sBachillerato" id="sInstituto"></select>
			<label for="fIngreso2">Fecha Ingreso</label>
			<input type="text" id="fIngreso" name="fIngreso2" class="fecha">
			<label for="fEgresoOE">Fecha Egreso</label>
			<input type="text" id="fEgresoOE"  class="fecha">
			<label for="titulo">Titulo</label>
			<input type="text" name="texto" id="titulo" required>
			<input type="button" id="btOE" value="Guardar">
		</form>
	</div>
	<div id="lista"></div>
	<div id="addIL">
		<form id="">
			<label for="sPais3">Pais</label>
			<select name="sPais" id="sPais3"></select>
			<label for="sDep3">Departamento</label>
			<select name="sDep" id="sDep3"></select>
			<label for="sMun3">Ciudad</label>
			<select name="sMun" id="sMun3"></select>
			
			<label for="fIngreso3">Fecha Ingreso</label>
			<input type="text" id="fIngreso3" name="fIngreso3" class="fecha">
			<label for="fEgresoIL">Fecha Egreso</label>
			<input type="text" id="fEgresoIL"  class="fecha">
		</form>
		<div id="auto"> 
			<label for="empresa">Empresa</label>
			<input type="text" name="empresa" id="empresa" placeholder="Minimo 3 letras">
			<label for="cargos">Cargo</label>
			<input type="text"  id="cargos">
		</div>
		<input type="button" id="btIL" value="Guardar">				
	</div>
